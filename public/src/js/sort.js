var btnAll = document.getElementById("sort-all"),
    ...
    cards = {design:["Waterloop", "watonomous", "biotron"], coop:["im", "ford"],
             course:["mods", "1A", "tron-days"], side: ["elongboard", "drone", "website", "app", "3D"],
             hackathons:["htv", "qhacks", "dhacks", "penn", "princeton", "wearhacks", "IEEE"], hs:["robotics-hs", "catapult"]},
    cardsAll = ["Waterloop", "watonomous", "biotron", "im", "ford", "mods", "1A", "tron-days", "elongboard", "drone", "website", "app", "3D", "htv", "qhacks", "dhacks", "penn", "princeton", "wearhacks", "IEEE", "robotics-hs", "catapult"];
